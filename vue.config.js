...
module.exports = {
  ...
  css: {
    ...
    loaderOptions: {
      scss: {
        prependData: `$ASSETS: '${process.env.VUE_APP_ASSETS_URL}'; @import "~@assets/css/mixins.scss"; @import "~@assets/css/vuetify.scss"; @import "~@assets/css/variables.scss"; @import "~@assets/css/main.scss"; @import "~@assets/css/icons.scss"; @import "~@assets/css/typography.scss"; @import "~@assets/css/vendors.scss"; @import "~@assets/css/print.scss";`,
      },
    },
  },
