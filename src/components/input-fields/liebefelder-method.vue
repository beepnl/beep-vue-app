    ...
    <div class="border-bottom">
      ...
      <ul>
        ...
        <li
          ...
          frames in the hive. The BEEP app will automatically calculate the sum
          of bees.</li
        >
        <li
          >Then remove the bees from the frame before counting the other targets
          one by one. Frames do not need to be free of bees completely. It is
          fine if bees stay on the frame as long as the brood and/or food
          reserves are visible and can be estimated.</li
        >
        <li
          ...
          hand on the hand holding the ear (a little rough on the eggs), or use
          a feather or soft brush (not very hygienic).</li
        >
        <li
        ...
        <li
          ...
          such that in theory we could ‘rebuild’ the colony frame by frame.</li
        >
      </ul>
    </div>
