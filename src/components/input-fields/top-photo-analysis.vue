			...
			<div class="border-bottom">
				...
				<ol class="ml-4">
					...
					<li>
						...
						frame in the photo, and use a standard angle (35mm) (Figure 1).
					</li>
				</ol>
				<img
					style="width:100%;"
	...
	export default {
		...
		methods: {
			calculateTpaColonySize() {
				...
				setTimeout(() => {
					...
					if (
						...
						const ratio =
							pixelsTotal > pixelsBees ? pixelsBees / pixelsTotal : 1;
			...
			setInputNumbers() {
				...
				this.framesForCalculation = this.getMaxFramecount(
					this.activeHive.layers,
				);
			},
		},
	};
