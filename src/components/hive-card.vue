  ...
  <v-menu location="right">
      ...
      >
        ...
        >
          <div class="hive-icon-wrapper d-flex flex-column align-center">
            ...
            <HiveIcon v-bind="props" :hive="hive"></HiveIcon>
          </div>
          ...
          <div v-if="!xsView" class="hive-details-icons-text pl-2 pr-0 py-0">
            ...
            >
              <div class="mr-2 my-0">
                <router-link :to="inspectLink(true)">
                  <v-sheet class="beep-icon beep-icon-note color-grey">
                  </v-sheet>
                </router-link>
              </div>
              <v-tooltip
    ...
    <v-list density="compact" class="hive-menu-list" variant="flat">
      ...
      <v-list-item
        ...
        :title="$tc('View_alert', alerts.length)"
      >
      </v-list-item>
      <v-list-item
        v-if="hive.sensors.length !== 0"
      ...
      >
        <template v-slot:prepend>
          <div class="beep-list-icon">
            <v-sheet class="beep-icon beep-icon-queen--no-outline"></v-sheet>
          </div>
        </template>
      </v-list-item>
