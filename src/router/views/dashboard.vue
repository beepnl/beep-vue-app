              ...
              >
                ...
                <template v-for="(sensorSet, index) in currentSensors">
                  <v-col
                    ...
                    :key="'sensor' + index"
                    cols="12"
                    :class="'dashboard-chart' + (landscapeMode ? ' pa-0' : '')"
                  >
                    <div
...
export default {
  ...
  computed: {
    ...
    whichSizeFits() {
      var largeHiveWidth = 90
      var mediumHiveWidth = 70
      var apiaryWidth = this.landscapeMode
        ? this.stickyWidth * 0.78
        : this.screenSize * (this.tabletLandscapeAndUp ? 0.5 : 0.9)
      var requiredWidthLarge = this.dashboardHives.length * largeHiveWidth
      var requiredWidthMedium = this.dashboardHives.length * mediumHiveWidth
