...
const translations = {
  ...
  group_activated: 'Gruppeinnvitasjon godtatt',
  group_declined: 'Gruppeinnvitasjonen ble avslått',
  ...
  Hive_order: 'Bikube rekkefølge i bigården',
  ...
  Hive_brood_layer: 'Yngel lag | Yngel lag',
  Hive_honey_layer: 'Skattekasse lag | Skattekasse lag',
  Hive_queen_excluder_layer: 'Dronning gitter | Dronninggittere',
  Hive_feeding_box_layer: 'Forkar | Forkar',
  drag_layers: 'Dra lag for å konfigurere bikuben',
  page: 'side | sider',
  Page: 'Side | Sider',
  not_found: 'ikke funnet',
  sorry: 'Sorry',
  delete_layer: 'Slett lag',
